          ...
          <div className="checkout-container">
            ...
            <div className="checkout-summary">
              ...
              <div className="checkout-total">
                ...
                <p className="check-total-value">${total.toFixed(2)}</p>
              </div>
              <div className="checkout-total">
                <p className="checkout-total-label">Subtotal:</p>
                <p className="check-total-value checkout-total-final">${total.toFixed(2)}</p>
              </div>
              <button className="btn btn-primary btn-large btn-black" onClick={placeOrder}>Place Order</button>
            </div>
          </div>
        </div>
      </div>
